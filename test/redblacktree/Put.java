...
public class Put {
  ...
  public void testCaseTwoL() {
    ...
    Node<Integer, String> expected = blackNode(1, redNode(0, empty(), empty()), empty());
    checkTrees(tree, expected);
  }
  ...
  public void testCaseTwoR() {
    ...
    Node<Integer, String> expected = blackNode(1, empty(), redNode(2, empty(), empty()));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeOne1() {
    ...
    Node<Integer, String> expected = blackNode(3, blackNode(1, redNode(0), empty()), blackNode(5));
  ...
  public void testCaseThreeOne2() {
    RedBlackTree<Integer, String> tree = threeOneTree();
    tree.put(2, "2");
    Node<Integer, String> expected = blackNode(3, blackNode(1, empty(), redNode(2)), blackNode(5));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeOne3() {
    RedBlackTree<Integer, String> tree = threeOneTree();
    tree.put(4, "4");
    Node<Integer, String> expected = blackNode(3, blackNode(1), blackNode(5, redNode(4), empty()));
  ...
  public void testCaseThreeOne4() {
    RedBlackTree<Integer, String> tree = threeOneTree();
    tree.put(6, "6");
    Node<Integer, String> expected = blackNode(3, blackNode(1), blackNode(5, empty(), redNode(6)));
    checkTrees(tree, expected);
  }
  ...
  private RedBlackTree<Integer, String> threeTwoTreeL() {
    return new RedBlackTree<Integer, String>(
        blackNode(7, blackNode(3, redNode(1), redNode(5)), blackNode(8)));
  }

  private RedBlackTree<Integer, String> threeTwoTreeR() {
    return new RedBlackTree<Integer, String>(
        blackNode(1, blackNode(0), blackNode(5, redNode(3), redNode(7))));
  }
  ...
  public void testCaseThreeTwo1() {
    ...
    Node<Integer, String> expected =
        blackNode(7, redNode(3, blackNode(1, redNode(0), empty()), blackNode(5)), blackNode(8));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeTwo2() {
    ...
    tree.put(2, "2");
    Node<Integer, String> expected =
        blackNode(7, redNode(3, blackNode(1, empty(), redNode(2)), blackNode(5)), blackNode(8));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeTwo3() {
    ...
    tree.put(4, "4");
    Node<Integer, String> expected =
        blackNode(7, redNode(3, blackNode(1), blackNode(5, redNode(4), empty())), blackNode(8));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeTwo4() {
    ...
    tree.put(6, "6");
    Node<Integer, String> expected =
        blackNode(7, redNode(3, blackNode(1), blackNode(5, empty(), redNode(6))), blackNode(8));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeTwo5() {
    ...
    tree.put(2, "2");
    Node<Integer, String> expected =
        blackNode(1, blackNode(0), redNode(5, blackNode(3, redNode(2), empty()), blackNode(7)));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeTwo6() {
    ...
    tree.put(4, "4");
    Node<Integer, String> expected =
        blackNode(1, blackNode(0), redNode(5, blackNode(3, empty(), redNode(4)), blackNode(7)));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeTwo7() {
    ...
    tree.put(6, "6");
    Node<Integer, String> expected =
        blackNode(1, blackNode(0), redNode(5, blackNode(3), blackNode(7, redNode(6), empty())));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeTwo8() {
    ...
    tree.put(8, "8");
    Node<Integer, String> expected =
        blackNode(1, blackNode(0), redNode(5, blackNode(3), blackNode(7, empty(), redNode(8))));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeFiveL() {
    ...
    tree.put(0, "0");
    Node<Integer, String> expected =
        blackNode(3, blackNode(1, redNode(0), redNode(2)), blackNode(4));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeFiveR() {
    ...
    tree.put(5, "5");
    Node<Integer, String> expected =
        blackNode(2, blackNode(1), blackNode(4, redNode(3), redNode(5)));
    checkTrees(tree, expected);
  }
  ...
  public void testCaseThreeFourFiveL() {
    RedBlackTree<Integer, String> tree =
        new RedBlackTree<Integer, String>(
            blackNode(
                10, redNode(2, blackNode(1), blackNode(6, redNode(4), redNode(8))), blackNode(11)));
  ...
  public void testCaseThreeFourFiveR() {
    RedBlackTree<Integer, String> tree =
        new RedBlackTree<Integer, String>(
            blackNode(
                2, blackNode(1), redNode(7, blackNode(4, redNode(3), redNode(5)), blackNode(8))));
